...
async function fetchSheetData() {
    try {
        const response = await fetch('https://script.google.com/macros/s/AKfycbz5zEMyMGTm4LLlMFMxdO3107RBTzpp0Gjg0VFmbeFPrU32b7cXdk-Yhk6grlkTfplj/exec');
...
function openGoogleSheet() {
    window.open('https://docs.google.com/spreadsheets/d/1YcT6euHC7U7Zd3UwMfrUTxJsfzk3PVqDQf9wExUILY0/edit?gid=0#gid=0', '_blank');
}
